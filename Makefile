...
debian/Release.gpg: debian/Release
	cd debian && rm -f Release.gpg && (echo ${KEY_PASSPHRASE} | gpg --pinentry-mode loopback --passphrase-fd 0 -abs -o Release.gpg --local-user "Universal Apt Repository" Release)
